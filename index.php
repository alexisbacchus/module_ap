...
require_once 'includes/mybacchus_settings.php';
...
<body id="page-top">
  ...
  <div id="wrapper">
    <!-- Sidebar -->
    <ul
      class="navbar-nav sidebar sidebar-light d-none d-md-block accordion <?php echo (isset($toggleState)) ? $toggleState : null ; ?>"
      id="accordionSidebar">
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?page=wlan0_info">
        <div class="sidebar-brand-text ml-1">Module conf</div>
      </a>
      <!-- Divider -->
      <hr class="sidebar-divider my-0">
      <li class="nav-item">
        <a class="nav-link" href="index.php?page=mybacchus_settings"><i class="fas fa-wine-glass fa-fw mr-2"></i><span class="nav-label">Configuration MyBacchus</a>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="index.php?page=auth_conf">
                <span
                  class="mr-2 d-none d-lg-inline small"><?php echo htmlspecialchars($config['admin_user'], ENT_QUOTES); ?></span>
        ...
        case "system_info":
            DisplaySystem();
            break;
        case "mybacchus_settings":
            DisplayMyBacchusSettings();
            break;
        case "about":
            DisplayAbout();
            break;
